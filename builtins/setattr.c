...
readonly_builtin (list)
     register WORD_LIST *list;
{
  return r_readonly_builtin(list);
...
int
__set_or_show_attributes (list, attribute, nodefs)
     register WORD_LIST *list;
...
/* Show all variable variables (v == 1) or functions (v == 0) with
   attributes. */
int
__show_all_var_attributes (v, nodefs)
     int v, nodefs;
{
...
int
__show_local_var_attributes (v, nodefs)
     int v, nodefs;
{
  SHELL_VAR **variable_list, *var;
  int any_failed;
...
int
__var_attribute_string (var, pattr, flags)
     SHELL_VAR *var;
     int pattr;
...
int
__show_var_attributes (var, pattr, nodefs)
     SHELL_VAR *var;
     int pattr, nodefs;
{
...
int
__show_name_attributes (name, nodefs)
     char *name;
     int nodefs;
{
  SHELL_VAR *var;
...
int
__show_localname_attributes (name, nodefs)
     char *name;
     int nodefs;
{
  SHELL_VAR *var;
...
int
__show_func_attributes (name, nodefs)
     char *name;
     int nodefs;
{
  SHELL_VAR *var;
...
void
__set_var_attribute (name, attribute, undo)
     char *name;
     int attribute, undo;
{
